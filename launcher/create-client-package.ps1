...
Write-Host "`n📋 Files in Package:" -ForegroundColor Yellow
...
Write-Host "`n📦 ZIP Size: $zipSize MB" -ForegroundColor Cyan

Write-Host ""
Write-Host "Ready to share with client!" -ForegroundColor Green
